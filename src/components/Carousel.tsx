...
export const EmblaCarousel = () => {
  ...
  return (
    <div className="relative"> 
     <button onClick={scrollPrev} className="md:w-12 z-50 md:h-12 w-8 h-8 flex items-center justify-center bg-color-clicado/70 text-color-black absolute left-0 top-1/2 -translate-y-1/2 ">
        <BiChevronLeft size={28}></BiChevronLeft>
      </button>
      <button onClick={scrollNext} className="md:w-12 z-50 md:h-12 w-8 h-8 flex items-center justify-center bg-color-clicado/70 text-color-black absolute right-0 top-1/2 -translate-y-1/2">
    ...
    <div className="embla" ref={emblaRef}>
     ...
     <div className="embla__container">
        ...
        <div className="embla__slide">
          <Item image={imagem1}><div className="font-serif  md:ml-0 lg:mr-96">
        ...
        <div className="embla__slide">
          <Item image={imagem2}><div className="font-serif md:ml-0 lg:mr-96">
          <h1 className="text-color-clicado text-sm md:text-lg lg:text-3xl">Defendendo seus direitos</h1>
            ...
            <a target='_blank' href="https://wa.me/553199788997?text=Quero discutir meu caso. Podemos conversar?"><Botao>Agende uma consultoria</Botao></a>
            </div>
            
          </Item>
        </div>
        <div className="embla__slide">
          <Item image={imagem3}><div className="font-serif md:ml-0 lg:mr-96">
            ...
            <a target='_blank' href="https://wa.me/553199788997?text=Quero discutir meu caso. Podemos conversar?"><Botao>Marque uma reunião conosco</Botao></a>
            </div></Item>
        </div>
      </div> 
