...
export default function topnav() {
  return (
    <div className="bg-color-black2 min-h-[40px] lg:flex-row text-color-white flex justify-evenly items-center flex-col">
        <div className='flex-row flex items-center gap-3 text-sm'>
            ...
            <h2 className='text-sm'>1435, Kleemov Street, São Paulo, 95032-140</h2>
        </div>
        ...
        <div className='text-color-clicado flex justify-center items-center  min-h-[40px]'>
            <div>
                <a target ="_blank" href='https://pt-br.facebook.com/'>
                    ...
                    min-h-[40px] w-11 border-r border-[#686767] flex justify-center items-center
            ...
            <div>
                <a target ="_blank" href='https://pt-br.facebook.com/'>
                    ...
                    min-h-[40px] w-11 border-r border-[#686767] hover:shadow-[#ea4335]/20 focus:shadow-[#ea4335]/20 active:shadow-[#ea4335]/10">
